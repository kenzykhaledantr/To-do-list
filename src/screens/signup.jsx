...
const SignUp = ({navigation}) => {
    ...
    const validate = () => {
        ...
        if (!Password.trim()) {
          ...
          newErrors.Password='Password must be 8+ chars, include uppercase, lowercase, number & special character'
  }
        if (!repeatPassword.trim()) {
            ...
            newErrors.repeatPassword='password doesn not match'
        }
 ...
 const dispatch = useDispatch();
    ...
    try {
        ...
        // Save basic profile in Firestore: users/{uid}
        await setDoc(doc(db, "users", userCredential.user.uid), {
            name,
            email: Email,
        });
        console.log('User created & verification email sent:', userCredential.user.uid);
    ...
    return (
        <View style={style.container}>
           ...
           {errors.Email && <Text style={style.errorText}>{errors.Email}</Text>}
            ...
            <View style={[style.input, errors.repeatPassword && style.inputError,{ flexDirection: "row", alignItems: "center" }]}>
            <TextInput placeholder="Repeat Password "
                ...
                onChangeText={(text) => {
                    ...
                    if (errors.repeatPassword) setErrors((prev) => ({ ...prev, repeatPassword: null }));
            ...
            {errors.repeatPassword && <Text style={style.errorText}>{errors.repeatPassword}</Text>}
